...
const togglePaswrd = document.querySelector("#togglePaswrd");
const paswrd = document.querySelector("#paswrd");

togglePaswrd.addEventListener("click", function () {
...
const toggleconpass = document.querySelector("#toggleconpass");
